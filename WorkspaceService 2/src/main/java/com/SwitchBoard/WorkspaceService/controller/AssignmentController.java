...
public class AssignmentController {
    ...
    public ResponseEntity<ApiResponse> createAssignment(
        ...
        ApiResponse response = ApiResponse.success("Assignment created successfully", assignmentResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> updateAssignment(
        ...
        ApiResponse response = ApiResponse.success("Assignment updated successfully", assignmentResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> deleteAssignment(
        ...
        ApiResponse response = ApiResponse.success("Assignment deleted successfully", null, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> addTasksToAssignment(
        ...
        ApiResponse response = ApiResponse.success("Tasks added to assignment successfully", assignmentResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> removeTasksFromAssignment(
        ...
        ApiResponse response = ApiResponse.success("Tasks removed from assignment successfully", assignmentResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> assignUsersToAllTasks(
        ...
        ApiResponse response = ApiResponse.success("Users successfully assigned to all tasks in assignment", assignmentResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> unassignUsersFromAllTasks(
        ...
        ApiResponse response = ApiResponse.success("Users successfully unassigned from all tasks in assignment", null, httpRequest.getRequestURI());
