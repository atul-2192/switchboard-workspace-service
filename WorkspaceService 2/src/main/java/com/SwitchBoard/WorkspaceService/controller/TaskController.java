...
public class TaskController {
    ...
    public ResponseEntity<ApiResponse> createTask(
        ...
        ApiResponse response = ApiResponse.success("Task created successfully", taskResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> updateTask(
        ...
        ApiResponse response = ApiResponse.success("Task updated successfully", taskResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> updateTaskStatus(
        ...
        ApiResponse response = ApiResponse.success("Task status updated successfully", taskResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> assignTask(
        ...
        ApiResponse response = ApiResponse.success("Task assigned successfully", taskResponse, httpRequest.getRequestURI());
    ...
    public ResponseEntity<ApiResponse> deleteTask(
        ...
        ApiResponse response = ApiResponse.success("Task deleted successfully", null, httpRequest.getRequestURI());
